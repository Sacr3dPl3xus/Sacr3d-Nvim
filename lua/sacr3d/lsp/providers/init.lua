...
local default_config = require('sacr3d.lsp.providers.defaults')
...
lsp_installer.on_server_ready(function(server)
  ...
  elseif server.name == 'jsonls' then
    opts = utils.merge(opts, require('sacr3d.lsp.providers.jsonls'))
  elseif server.name == 'sumneko_lua' then
    opts = utils.merge(opts, require('sacr3d.lsp.providers.sumneko_lua'))
  end
