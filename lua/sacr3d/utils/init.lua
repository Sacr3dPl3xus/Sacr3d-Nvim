...
local function clear_cache()
  if 0 == vim.fn.delete(vim.fn.stdpath('config') .. '/lua/sacr3d/compiled.lua') then
    vim.cmd(':LuaCacheClear')
  end
end

function M.post_reload(msg)
  local Logger = require('sacr3d.utils.logger')
  unload('sacr3d.utils', true)
  unload('sacr3d.theme', true)
  unload('sacr3d.plugins.statusline', true)
...
function M.reload_user_config_sync()
  ...
  clear_cache()
  unload('sacr3d.config', true)
  unload('sacr3d.core.pluginsInit', true)
  vim.cmd([[autocmd User PackerCompileDone ++once lua require('sacr3d.utils').post_reload()]])
  vim.cmd(':PackerSync')
end
